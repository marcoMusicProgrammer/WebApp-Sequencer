...
/*
function panBufSlider(counter,PANdiv) {
    ...
    inputPan.oninput = ()=>{updateSamplePan(counter,spanPan,inputPan)}

}

function updateSamplePan(counterOsc,spanPan,inputPan) {
    console.log(panSamples)

    spanPan.textContent = parseFloat(inputPan.value).toFixed(2)
    panSamples[counterOsc].pan.value = inputPan.value
